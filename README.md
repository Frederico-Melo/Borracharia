...
- Valores de venda e custo do estoque no Dashboard: total geral e valores de pneus, rodas e bicos.
...
- Pagamento no cartão de 1x a 12x: taxa automática, opção de repassar ou absorver a taxa para clientes especiais, total no cartão, valor de cada parcela e valor líquido gravados no Histórico, Caixa e Relatórios desde a venda.
...
- O lucro de uma venda é `valor líquido recebido − custo dos produtos e peças avulsas`; serviços e mão de obra entram integralmente no lucro. No cartão, a taxa pode ser repassada ao cliente ou absorvida pela loja.
